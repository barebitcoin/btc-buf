...
var file_bitcoin_bitcoind_v1alpha_bitcoin_proto_rawDesc = []byte{
	...
	0x65, 0x32, 0xbc, 0x05, 0x0a, 0x0e, 0x42, 0x69, 0x74, 0x63, 0x6f, 0x69, 0x6e, 0x53, 0x65, 0x72,
	...
	0x63, 0x6f, 0x69, 0x6e, 0x2e, 0x62, 0x69, 0x74, 0x63, 0x6f, 0x69, 0x6e, 0x64, 0x2e, 0x76, 0x31,
	0x61, 0x6c, 0x70, 0x68, 0x61, 0x2e, 0x47, 0x65, 0x74, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x49,
	0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x55, 0x0a, 0x04, 0x53,
...
var file_bitcoin_bitcoind_v1alpha_bitcoin_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_bitcoin_bitcoind_v1alpha_bitcoin_proto_goTypes = []interface{}{
	...
	(*GetRawTransactionRequest)(nil),               // 11: bitcoin.bitcoind.v1alpha.GetRawTransactionRequest
	(*GetRawTransactionResponse)(nil),              // 12: bitcoin.bitcoind.v1alpha.GetRawTransactionResponse
	(*SendRequest)(nil),                            // 13: bitcoin.bitcoind.v1alpha.SendRequest
	(*SendResponse)(nil),                           // 14: bitcoin.bitcoind.v1alpha.SendResponse
	(*GetTransactionResponse_Details)(nil),         // 15: bitcoin.bitcoind.v1alpha.GetTransactionResponse.Details
	(*GetRawTransactionResponse_Input)(nil),        // 16: bitcoin.bitcoind.v1alpha.GetRawTransactionResponse.Input
	(*GetRawTransactionResponse_ScriptPubKey)(nil), // 17: bitcoin.bitcoind.v1alpha.GetRawTransactionResponse.ScriptPubKey
	(*GetRawTransactionResponse_Output)(nil),       // 18: bitcoin.bitcoind.v1alpha.GetRawTransactionResponse.Output
	nil,                                            // 19: bitcoin.bitcoind.v1alpha.SendRequest.DestinationsEntry
...
var file_bitcoin_bitcoind_v1alpha_bitcoin_proto_depIdxs = []int32{
	...
	20, // 1: bitcoin.bitcoind.v1alpha.GetTransactionResponse.block_time:type_name -> google.protobuf.Timestamp
	20, // 2: bitcoin.bitcoind.v1alpha.GetTransactionResponse.time:type_name -> google.protobuf.Timestamp
	20, // 3: bitcoin.bitcoind.v1alpha.GetTransactionResponse.time_received:type_name -> google.protobuf.Timestamp
	...
	15, // 5: bitcoin.bitcoind.v1alpha.GetTransactionResponse.details:type_name -> bitcoin.bitcoind.v1alpha.GetTransactionResponse.Details
	16, // 6: bitcoin.bitcoind.v1alpha.GetRawTransactionResponse.vin:type_name -> bitcoin.bitcoind.v1alpha.GetRawTransactionResponse.Input
	18, // 7: bitcoin.bitcoind.v1alpha.GetRawTransactionResponse.vout:type_name -> bitcoin.bitcoind.v1alpha.GetRawTransactionResponse.Output
	19, // 8: bitcoin.bitcoind.v1alpha.SendRequest.destinations:type_name -> bitcoin.bitcoind.v1alpha.SendRequest.DestinationsEntry
	1,  // 9: bitcoin.bitcoind.v1alpha.GetTransactionResponse.Details.category:type_name -> bitcoin.bitcoind.v1alpha.GetTransactionResponse.Category
	17, // 10: bitcoin.bitcoind.v1alpha.GetRawTransactionResponse.Output.script_pub_key:type_name -> bitcoin.bitcoind.v1alpha.GetRawTransactionResponse.ScriptPubKey
	2,  // 11: bitcoin.bitcoind.v1alpha.BitcoinService.GetBlockchainInfo:input_type -> bitcoin.bitcoind.v1alpha.GetBlockchainInfoRequest
	9,  // 12: bitcoin.bitcoind.v1alpha.BitcoinService.GetTransaction:input_type -> bitcoin.bitcoind.v1alpha.GetTransactionRequest
	4,  // 13: bitcoin.bitcoind.v1alpha.BitcoinService.GetNewAddress:input_type -> bitcoin.bitcoind.v1alpha.GetNewAddressRequest
	6,  // 14: bitcoin.bitcoind.v1alpha.BitcoinService.GetWalletInfo:input_type -> bitcoin.bitcoind.v1alpha.GetWalletInfoRequest
	13, // 15: bitcoin.bitcoind.v1alpha.BitcoinService.Send:input_type -> bitcoin.bitcoind.v1alpha.SendRequest
	11, // 16: bitcoin.bitcoind.v1alpha.BitcoinService.GetRawTransaction:input_type -> bitcoin.bitcoind.v1alpha.GetRawTransactionRequest
	3,  // 17: bitcoin.bitcoind.v1alpha.BitcoinService.GetBlockchainInfo:output_type -> bitcoin.bitcoind.v1alpha.GetBlockchainInfoResponse
	10, // 18: bitcoin.bitcoind.v1alpha.BitcoinService.GetTransaction:output_type -> bitcoin.bitcoind.v1alpha.GetTransactionResponse
	5,  // 19: bitcoin.bitcoind.v1alpha.BitcoinService.GetNewAddress:output_type -> bitcoin.bitcoind.v1alpha.GetNewAddressResponse
	7,  // 20: bitcoin.bitcoind.v1alpha.BitcoinService.GetWalletInfo:output_type -> bitcoin.bitcoind.v1alpha.GetWalletInfoResponse
	14, // 21: bitcoin.bitcoind.v1alpha.BitcoinService.Send:output_type -> bitcoin.bitcoind.v1alpha.SendResponse
	12, // 22: bitcoin.bitcoind.v1alpha.BitcoinService.GetRawTransaction:output_type -> bitcoin.bitcoind.v1alpha.GetRawTransactionResponse
