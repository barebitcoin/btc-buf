...
func (c *Client) CreateRawTransactionAsync(ctx context.Context, inputs []btcjson.TransactionInput,
	amounts map[address.Address]btcutil.Amount, lockTime *int64,
...
func (c *Client) SearchRawTransactionsAsync(ctx context.Context, address address.Address, skip, count int, reverse bool, filterAddrs []string) FutureSearchRawTransactionsResult {
...
func (c *Client) SearchRawTransactions(ctx context.Context, address address.Address, skip, count int, reverse bool, filterAddrs []string) ([]*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactionsVerboseAsync(ctx context.Context, address address.Address, skip,
...
func (c *Client) SearchRawTransactionsVerbose(ctx context.Context, address address.Address, skip,
	count int, includePrevOut, reverse bool, filterAddrs []string,
